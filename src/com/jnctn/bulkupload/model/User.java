 ...
 * @author martin
 */
public class User implements IUploadable {
    ...
    public void setShouldSendEmail(boolean shouldSend) {
        this.shouldSendEmail = shouldSend;
    }
