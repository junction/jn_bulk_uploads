...
import com.jnctn.bulkupload.model.json.UserAddressEditResponse;
...
public class UserAddressEdit extends AbstractWebservice<UserAddressEditResponse> {
   ...
   */
   ...
   @Override
   public UserAddressEditResponse sendRequest(Map<String,String> parameters) throws IOException {
